...
<a href="../../th2_data_services/data.py#L597"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
```python
map_stream(adapter_or_generator: Union[IAdapter, Callable])
```
