...
# from th2.data_services import MESSAGE_FIELDS_RESOLVER
from typing import Callable, Dict, Iterable, List, Set
import th2.data_services.utils.display
import th2.data_services.utils.time
from th2.data_services.utils._types import Th2Message
...
def print_totals(messages: Iterable[Th2Message], categorizers: List[Callable], filter_: Callable = None) -> None:
    ...
    th2.data_services.utils.display.print_stats_dict(result)
