...
from th2.data_services.utils.message_utils import message_utils
from th2.data_services.utils.event_utils import event_utils
from datetime import datetime
import th2.data_services.utils.az_tree
...
from th2.data_services.utils.viewer_structs.verification import (
...
def generate_generic_tree_and_index_from_parents_list(events, parents):  # noqa
    # TODO: Add docstrings
    tree, index = th2.data_services.utils.az_tree.get_event_tree_from_parent_events(
        events,
        parents,
        depth=10,
...
def generate_model_matrix_tree_and_index(events, parents_filter, extra=None):  # noqa
    ...
    th2.data_services.utils.az_tree.transform_tree(
        index,
        {
...
def generate_generic_json_report_limited_batches(
    ...
    for i in range(n_steps):
        ...
        if post_processors_dict is not None:
            ...
            th2.data_services.utils.az_tree.transform_tree(index, post_processors_dict)
        tree_shtrikh = {}
        ...
        th2.data_services.utils.az_tree.save_tree_as_json(tree_shtrikh, reports_path, lambda n, l: n)


def generate_generic_json_report(events, reports_path, parents_filter, one_file=False):  # noqa
    # TODO: Add docstrings
    tree, index = generate_generic_tree_and_index(events, parents_filter)
    th2.data_services.utils.az_tree.save_tree_as_json(tree, reports_path, lambda n, l: "all" if one_file else n)
...
def prepare_story(story_items_list, json_path=None, events=None, event_body_processors=None, messages=None):  # noqa
    ...
    if json_path is not None:
        th2.data_services.utils.az_tree.tree_walk_from_jsons(
