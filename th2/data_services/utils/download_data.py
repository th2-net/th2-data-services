...
from th2.data_services.provider.v5.commands import http
from th2.data_services.provider.v5.data_source import HTTPProvider5DataSource
from th2.data_services.provider.v5.filters.event_filters import TypeFilter
from th2.data_services.utils import event_utils
import th2.data_services
...
def download_events(
    ...
    Returns:
        Data
    """
    th2.data_services.INTERACTIVE_MODE = True
