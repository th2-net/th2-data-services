...
from typing import List, Tuple, Generator, Callable, Optional, Union, TypeVar, Generic
...
class CommonEventTree(Generic[Event]):
    ...
    def __getitem__(self, id_: str) -> Event:
    ...
    def _iter_ancestors(self, id: str) -> Generator[Event, None, None]:
    ...
    def get_subtree(self, id: str) -> "CommonEventTree":
        ...
        et = CommonEventTree(event_name="0", event_id="0")
        et._tree = subtree

        return et

    def merge_tree(self, parent_id: str, other_tree: "CommonEventTree", use_deepcopy: bool = False) -> None:
    ...
    def show(self) -> None:
        ...
        #   File "C:\Users\admin\exactpro\prj\th2\internal\DS\github\th2-data-services\th2_data_services\event_tree\common_event_tree.py", line 475, in show
        #     self._tree.show()
    ...
    def summary(self) -> str:
        ...
        # TODO - add levels info
        # ET(name=123, id=123, events=444)
        #   Levels
        #    num: 6
        #    l0 - 1 event
        #    l1 - 10 events
        #    l2 - 221 events
        # TODO - we can add more info in TH2 EventTree
