...
CORE_EXTRAS_DEPENDENCIES: Dict[str, List[str]] = {
    ...
    'rdp-dev':   ['th2-data-services-rdp', ],
    'rdp5-dev':  ['th2-data-services-rdp>=5.*,<6.*', ],
    'rdp6-dev':  ['th2-data-services-rdp>=6.*,<7.*', ],
    'lwdp-dev':  ['th2-data-services-lwdp', ],
    'lwdp1-dev': ['th2-data-services-lwdp>=1.*,<2.*', ],
}
