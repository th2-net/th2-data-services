...
def test_find_message_by_id_from_data_provider_with_error(data_source: HTTPProviderDataSource):
...
def test_get_events_from_data_provider_with_error(data_source: HTTPProviderDataSource):
    data_source = data_source
...
def test_get_messages_from_data_provider_with_error(data_source: HTTPProviderDataSource):
    data_source = data_source
...
def test_attached_messages(data_source: HTTPProviderDataSource):
