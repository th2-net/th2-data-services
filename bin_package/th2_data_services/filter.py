...
if v == "1.1.0":  # v6
    from bin_package.th2_data_services.provider.v6.filters.filter import Provider6Filter as ProviderFilter  # noqa
elif v == "0.0.4":  # v5
    from bin_package.th2_data_services.provider.v5.filters.filter import Provider5Filter as ProviderFilter  # noqa
