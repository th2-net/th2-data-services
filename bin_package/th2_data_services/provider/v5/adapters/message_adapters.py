...
from bin_package.th2_data_services.interfaces.adapter import IMessageAdapter
from bin_package.th2_data_services.provider.v5.struct import Provider5MessageStruct, provider5_message_struct
