...
from bin_package.th2_data_services.interfaces.adapter import IEventAdapter
from bin_package.th2_data_services.provider.v5.struct import Provider5EventStruct, provider5_event_struct
