...
from bin_package.th2_data_services.provider.interfaces import IEventStruct, IMessageStruct, IEventStub, IMessageStub

if TYPE_CHECKING:
    from bin_package.th2_data_services.provider.v5.interfaces.command import IHTTPProvider5Command

from bin_package.th2_data_services.provider.interfaces.data_source import IHTTPProviderDataSource
from bin_package.th2_data_services.provider.v5.struct import (
    provider5_event_struct,
    provider5_message_struct,
    Provider5EventStruct,
    Provider5MessageStruct,
)
from bin_package.th2_data_services.provider.v5.stub_builder import (
