...
pip list
python3 -m pytest tests/tests_integration -n auto --ignore tests/${PATH_DIFF_VERSION}/tests_v5

# RDP 5
echo '----========RDP5 tests========----'
pip install protobuf==3.20.3 mypy-protobuf==3.2.0 th2-grpc-common==3.11.1 th2-grpc-data-provider==0.1.6 -U -q
pip list
python3 -m pytest tests/tests_integration -n auto --ignore tests/${PATH_DIFF_VERSION}/tests_v6
